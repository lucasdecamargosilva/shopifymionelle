(function () {
    ...
    if (window.__PL_MIONELLE_LOADED__) { console.log('[PL] Widget Mionelle já carregado — ignorando duplicata.'); return; }
    window.__PL_MIONELLE_LOADED__ = true;
    console.log('[PL] Widget Mionelle carregado | URL:', window.location.pathname);
    // ===============================================
    // 0. CHUMBAR A API KEY AQUI DIRETO NO CÓDIGO
    // ===============================================
    const apiKey = "pl_live_3a4956c4683b6bddbe81ec4006f336651c723d5832fc6d8c";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/mionelle-check-limit';
    ...
    function getInstallment() {
        // Shopify Mionelle: preserva parcelas, valor e juros publicados pelo tema.
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <span style="font-size:20px;letter-spacing:3px">MIONELLE</span>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=mionelle" target="_blank" rel="dofollow noopener" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=mionelle" target="_blank" rel="dofollow noopener" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        ...
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone: '55' + phoneInput.value.replace(/\D/g, ''), loja: 'mionelle', origin: location.origin })
...
const fd = new FormData();
                ...
                try {
                    ...
                    // Regra Mionelle: envia todas as fotos do óculos no rosto como referências.
                ...
                console.log('[PL Mionelle] Enviando', allProdImgs.length, 'fotos do produto');
 ...
 startLoadingProgress(); } catch (_) {}
            ...
            try { document.getElementById('q-loading-box').style.display = 'none'; } catch (_) {}
                ...
                alert('Não foi possível conferir seu limite. Tente novamente.'); try { document.getElementById('q-loading-box').style.display='none'; uploadStep.style.display='flex'; genBtn.disabled=false; } catch (_) {} return;
            }
